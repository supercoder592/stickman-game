...
export const ROSTER = [
  {
    ...
    gear: { head: 'welder', shoulder: 'heavy', back: 'none', chest: 'plate' },
    palette: { armor: '#c05a2a', cloth: '#6b4a32', armorMat: 'rust', metalMat: 'iron' },
  ...
  },
  {
    ...
    gear: { head: 'goggles', shoulder: 'plate', back: 'coil', chest: 'plate' },
    palette: { armor: '#1f6f5c', cloth: '#2d4a46', armorMat: 'iron', metalMat: 'steel' },
  ...
  },
  {
    ...
    gear: { head: 'gasmask', shoulder: 'plate', back: 'none', chest: 'plate' },
    palette: { armor: '#5d6b2a', cloth: '#3a3f2a', armorMat: 'rust', metalMat: 'steel' },
  ...
  },
  {
    ...
    gear: { head: 'hood', shoulder: 'none', back: 'cloak', chest: 'bare' },
    palette: { armor: '#3e2f5c', cloth: '#2a2438', armorMat: 'darkIron', metalMat: 'steel' },
  ...
  },
  {
    ...
    gear: { head: 'mask', shoulder: 'none', back: 'sheath', chest: 'plate' },
    palette: { armor: '#5c2740', cloth: '#22202b', armorMat: 'darkIron', metalMat: 'steel' },
  ...
  },
  {
    ...
    gear: { head: 'horned', shoulder: 'heavy', back: 'none', chest: 'plate' },
    palette: { armor: '#7a1f1f', cloth: '#3b2222', armorMat: 'iron', metalMat: 'steel' },
  ...
  },
  {
    ...
    gear: { head: 'helmet', shoulder: 'heavy', back: 'none', chest: 'plate' },
    palette: { armor: '#6f5a22', cloth: '#333a44', armorMat: 'iron', metalMat: 'steel' },
  ...
  },
  {
    ...
    gear: { head: 'helmet', shoulder: 'plate', back: 'none', chest: 'plate' },
    palette: { armor: '#24406e', cloth: '#2b3448', armorMat: 'steel', metalMat: 'steel' },
